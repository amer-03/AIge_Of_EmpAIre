...
class Buildings:
    def __init__(self, image, position, lettre, cout, hp, taille, build_time, population=0):
        self.image = image
    ...
    def calculate_build_time(self, villager_count):
        """Calculate actual build time based on villager count"""
        return (3 * self.build_time) / (villager_count + 2)
